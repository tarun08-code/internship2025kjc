...
const pageSections = {
  1: ['course-description', 'course-objective'],
  2: ['course-outcomes', 'course-articulation'],
  3: ['course-content', 'resources'],
  4: ['pedagogy', 'skill-matrix'],
  5: ['assessment-plan']
};
...
function goToPage(pageNumber) {
  ...
  // Scroll to the first section of the selected page
  scrollToPage(pageNumber);
}

function scrollToPage(pageNumber) {
  const sections = pageSections[pageNumber];
